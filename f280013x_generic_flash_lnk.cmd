MEMORY
{
   ...
   RAMLS0           : origin = 0x00008000, length = 0x00004A00
//   RAMLS1           : origin = 0x0000A000, length = 0x00001FF8
   ...
   FLASH_BANK0_SEC_0_7     : origin = 0x080002, length = 0x01FFE  /* on-chip Flash */
   FLASH_BANK0_SEC_8_103   : origin = 0x082000, length = 0x18000  /* on-chip Flash */
   FLASH_BANK0_SEC_104_119 : origin = 0x09A000, length = 0x04000  /* on-chip Flash */
   FLASH_BANK0_SEC_120_127 : origin = 0x09E000, length = 0x01FF0  /* on-chip Flash */
...
SECTIONS
{
   ...
   .text            : >> FLASH_BANK0_SEC_8_103, ALIGN(8)
   ...
   .const           : >> FLASH_BANK0_SEC_104_119, ALIGN(8)
   .data            : > RAMLS0
   .sysmem          : > RAMLS0
  .bss:cio          : > RAMLS0
#else
   ...
   .ebss            : > RAMLS0
   .econst          : >> FLASH_BANK0_SEC_104_119, ALIGN(8)
   .esysmem         : > RAMLS0
   .cio             : > RAMLS0
#endif
   ...
   IQmath           : > FLASH_BANK0_SEC_104_119, ALIGN(8)
   IQmathTables     : > FLASH_BANK0_SEC_104_119, ALIGN(8)
}
